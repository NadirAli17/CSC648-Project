...
const AboutUs = () => {
  const teamMembers = [
    ...
    { name: "Aidan Bayer-Calvert", role: "Front-end Lead", link: "/team/aidan-bayer-calvert" },
  ...
  return (
    <div className="about-us">
      <h1>About Us</h1>
      <p>
        Welcome to our project! We are a group of 7 dedicated team members working to create
        an amazing web application that helps users manage and track their career development.
      </p>
      <h2>Meet Our Team</h2>
      <ul>
